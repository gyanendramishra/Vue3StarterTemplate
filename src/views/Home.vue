<template>
    ...
    <div>
      <div class="relative w-full sm:w-2/3 lg:w-1/2 z-10">
        <h1 class="text-3xl lg:text-4xl xl:text-5xl leading-tight font-bold">
          Fair Rate lets you find the fairrest rate.
        </h1>
  ...
  >
    ...
    <div class="mt-12 md:mt-20 w-full md:max-w-3xl mx-auto">
      <p class="text-xl">
        &ldquo;FairRate is beautiful, elegant and easy to apply. I’ve been able
        to apply for an amazing rate in just a minutes. Thank you very much for
        creating this impressive service!&rdquo;
      </p>
  ...
  >
    ...
    <div class="flex flex-col md:flex-row mt-12 items-center justify-between">
      ...
      <div class="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
        ...
        <ul class="mt-6 text-white">
          <li>
            <div class="flex items-baseline">
              ...
              <span class="ml-2"
                >Integer posuere erat a ante venenatis dapibus</span
              >
            </div>
          </li>
          <li>
        ...
        <a
          href="#"
          class="inline-block px-6 py-4 bg-white text-blue-600 rounded-lg mt-8"
          >Find the Fair Rate</a
        >
      </div>
    </div>
    ...
    >
      <div class="w-full md:w-2/3">
        ...
        <p class="mt-2 md:max-w-md">
          Contact our Customer Support that is always ready to help you with any
          possible questions, problems or information.
        </p>
      </div>
      ...
      <div class="w-full md:w-1/3 md:text-right mt-6 md:mt-0">
        <a
          href="#"
          class="inline-block px-6 py-4 bg-blue-600 text-white rounded-lg"
          >Go to Support</a
        >
      </div>
    </div>
